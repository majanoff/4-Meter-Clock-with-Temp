...
const int ledPin =  13; 
int count;
int meter_hour_A[12] = {0,13,29,44,60,72,88,103,118,132,148,160};
...
int meter_temp_A[30] = {  0,6,12,18,24,30,36,42,48,54,60,66,72,78,84,90,96,102,108,114,120,126,136,142,148,154,160,166,172,176};
...
// set the time as follows: month day hour minutes seconds
 //************ 
 //************ set the date/time/ ************** 
 //rtc.adjust(DateTime(2024, 7, 27, 2, 56, 30));
